...
class BaseAlgorithm(ABC):
    ...
    def __init__(
        ...
        self.ep_collision_buffer = None  # type: deque | None
        self.ep_out_of_bound_buffer = None  # type: deque | None
        self.ep_timeout_buffer = None  # type: deque | None
        self.ep_success_len_buffer = None  # type: deque | None
        self.ep_success_dist_buffer = None  # type: deque | None
    ...
    def _setup_learn(
        ...
        if self.ep_info_buffer is None or reset_num_timesteps:
            ...
            self.ep_collision_buffer = deque(maxlen=self._stats_window_size)
            self.ep_out_of_bound_buffer = deque(maxlen=self._stats_window_size)
            self.ep_timeout_buffer = deque(maxlen=self._stats_window_size)
            self.ep_success_len_buffer = deque(maxlen=self._stats_window_size)
            self.ep_success_dist_buffer = deque(maxlen=self._stats_window_size)
